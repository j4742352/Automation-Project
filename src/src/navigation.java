...
public class navigation {
    ...
    public  <WebDriver, WebDriverWait, WebElement> void NavigationFunction() throws InterruptedException {
        ...
        WebElement attendanceBtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()='Attendance']/parent::a")));
        attendanceBtn.click();
    ...
    public  <WebDriver, WebDriverWait, WebElement> void NavigationFunction1(){
        ...
        WebElement reportBtn = wait.until(ExpectedConditions.elementToBeClickable(By.xpath("//span[text()='Report']/parent::a")));
        attendanceBtn.click();
